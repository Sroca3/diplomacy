...
public enum StandardVariantLocation implements Location {
    ...
    BELGIUM(new UnitType[]{UnitType.FLEET, UnitType.ARMY}, "Bel"),
    BERLIN(new UnitType[]{UnitType.FLEET, UnitType.ARMY}, "Ber", true),
    ...
    BURGUNDY(new UnitType[]{UnitType.FLEET, UnitType.ARMY}, "Bur"),
    ...
    KIEL(new UnitType[]{UnitType.FLEET, UnitType.ARMY}, "Kie", true),
    ...
    PRUSSIA(new UnitType[]{UnitType.FLEET, UnitType.ARMY}, "Pru"),
    ...
    SILESIA(new UnitType[]{UnitType.FLEET, UnitType.ARMY}, "Sil"),
    ...
    SWEDEN(new UnitType[]{UnitType.FLEET, UnitType.ARMY}, "Swe"),
