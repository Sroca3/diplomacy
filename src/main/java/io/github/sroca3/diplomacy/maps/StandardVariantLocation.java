...
public enum StandardVariantLocation implements Location {
    ...
    NORWAY(LocationType.COASTAL_LAND, "Nor", true),
    ...
    ST_PETERSBURG_NC(LocationType.COAST, "StP NC", true),
    ST_PETERSBURG_SC(LocationType.COAST, "StP SC", true),
    ST_PETERSBURG(LocationType.LAND, "StP", true, List.of(ST_PETERSBURG_NC, ST_PETERSBURG_SC), false),
